...
public static class CombatManager
{
        ...
        int attackerCommittedTroops = 0)
    {
        ...
        if (defenderTerritory.troops <= 0)
        {
            ...
            int committed = attackerCommittedTroops > 0 ? attackerCommittedTroops : lastAttackerDiceCount;
            int movingTroops = Mathf.Clamp(committed, 1, Mathf.Max(1, availableToMove));
