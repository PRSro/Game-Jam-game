...
public static class TerritoryGraph
{
    ...
    static void BuildRegions()
    {
        ...
        AddRegion("Iberia", new List<string> { "Madrid", "Lisbon", "Toledo" }, 3);
        AddRegion("France", new List<string> { "Paris", "Lyon", "Brussels", "Amsterdam", "Marseille" }, 4);
        AddRegion("Italy", new List<string> { "Rome", "Venice", "Florence", "Valletta", "Naples" }, 4);
        ...
        AddRegion("Eastern Europe", new List<string> { "Warsaw", "Moscow", "Kyiv", "Riga" }, 3);
        AddRegion("Balkans", new List<string> { "Constantinople", "Dubrovnik", "Belgrade", "Athens", "Bucharest" }, 3);
    }
